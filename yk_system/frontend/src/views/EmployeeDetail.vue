          ...
          <div v-else class="chart-wrap">
            ...
            >
              <rect
                ...
                fill="rgba(103,194,58,0.06)"
              />
              <line
                x1="0" :y1="hrY(150)" x2="800" :y2="hrY(150)"
                stroke="#e6a23c" stroke-width="1" stroke-dasharray="6,4" opacity="0.7"
              />
              <line
...
const MAX_HR_HISTORY_LENGTH = 60
...
async function pollLatest() {
  try {
    ...
    if (rawTime === lastSeenTime.value) return
...
.hd-text { font-size: 15px; font-weight: 600; color: var(--yk-text-primary); }
.chart-count { font-size: 12px; color: var(--yk-text-muted); margin-left: auto; }
...
.live-time { color: var(--yk-text-muted); font-size: 12px; }
